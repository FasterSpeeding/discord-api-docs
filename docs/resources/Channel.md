...
If `allowed_mentions` is empty or _not_ passed in (i.e. the key does not exist or the value is set to null), the mentions will be parsed via the content. This corresponds with existing behavior.
